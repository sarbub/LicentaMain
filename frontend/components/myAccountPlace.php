...
echo <<<HTML
    ...
    <div class="myAccountPlaceComponent">
        <img src="../images/sweep.jpg" class = "background_image" alt="">
    ...
    <div class="myAccountPlaceComponent">
        <img src="../images/dishes.jpg" class = "background_image" alt="">
        <span class = "after"></span>
        <div class="user_info">
    ...
    <div class="myAccountPlaceComponent">
        <img src="../images/hallWay.jpg" class = "background_image" alt="">
        <span class = "after"></span>
        <div class="user_info">
            <h3>Cleaning the hall way</h3>
        </div>
    </div>
    <div class="names_of_assigned">
    <p id="myName"> $given_to</p>
