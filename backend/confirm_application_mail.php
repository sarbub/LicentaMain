...
if ($user_email){
    try {
        ...
        //Recipients
        $mail->setFrom('bogdan.sarbu02@e-uvt.ro', 'CVSupport-team');
    ...
    <div style="background-color: white; border-radius: 10px; display: block; text-align: center; justify-content: center; align-items: center;">
        ...
        <h4 style="font-size: 18px;">This email confirms that your application has been sent</h4>
    </div>';
        ...
        echo "Application confirmation could not be sent. Mailer Error: {$mail->ErrorInfo}";
    }
} else {
